        ...
        for(Record i : target.getRecordsTableModel().getRecords())
        {
            if(i.getDate().getYear() == currentYear && i.getType().sign == type.sign)
            {
                switch (i.getDate().getMonth().getValue()) {
                    case 1: Months[0] += i.getAmount();
                        break;
                    case 2: Months[1] += i.getAmount();
                        break;
                    case 3: Months[2] += i.getAmount();
                        break;
                    case 4: Months[3] += i.getAmount();
                        break;
                    case 5: Months[4] += i.getAmount();
                        break;
                    case 6: Months[5] += i.getAmount();
                        break;
                    case 7: Months[6] += i.getAmount();
                        break;
                    case 8: Months[7] += i.getAmount();
                        break;
                    case 9: Months[8] += i.getAmount();
                        break;
                    case 10: Months[9] += i.getAmount();
                        break;
                    case 11: Months[10] += i.getAmount();
                        break;
                    case 12: Months[11] += i.getAmount();
                        break;
                }
            }
        }
